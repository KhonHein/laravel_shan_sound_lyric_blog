...
Route::middleware([
    ...
    Route::middleware(['adminAuthMiddleware'])->group(function () {
        ...
        Route::get('/category_list',[AdminController::class,'categoryList'])->name('admin#categoryList');
        Route::post('/category_list',[AdminController::class,'updateCategory'])->name('admin#updateCategory');
        Route::get('/category/delete/{id}',[AdminController::class,'deleteCategory'])->name('admin#deleteCategroy');
        // post
        ...
        Route::get('/admin/typing',[AdminController::class,'keyboardTyping'])->name('admin#keyboard');
    });
    ...
    Route::middleware(['usersAuthMiddleward'])->group(function(){
        ...
        Route::get('ajax/user/add_viewCount',[AjaxController::class,'addViewCount'])->name('user#addViewCount');
        ...
        Route::get('/user/typing',[UsersAuthController::class,'keyboardTyping'])->name('user#keyboard');
