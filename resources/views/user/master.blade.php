    ...
    <nav class=" border-bottom navbar  navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse " id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 d-flex justify-content-around" >
                ...
                <p class="cityName hideDiv fs-4 text-black fw-bold mt-1 mx-2 shanniFont"></p>
            ...
            <a href="{{ route('user#keyboard') }}" class="btn btn-secondary text-light rounded-pill py-1 px-2 ms-1"><i class="fa-regular fa-keyboard text-black fs-5 "></i></a>
        </div>
   ...
   <div class="main-containerCSS bg-secondary">
        <div class="splitCSS left-pane">
            <div class="leftContainer">
                ...
                <a href="{{ route('selectByCategory',$c->category_name) }}" onclick="showByCategory()" class="selectByCategory shadow-sm btn btn-secondary border rounded-4 my-2 d-block shanniFont fs-4" >{{ $c->category_name }}</a>
                @endforeach
            </div>
        </div>
        ...
        <div class="modal-content" style="background: rgba(29, 29, 39, 0.7);">
            ...
            <div class="modal-body d-flex align-items-center justify-content-center">
                <div class="input-group" style="max-width: 600px;">
                    <input name="key" type="text" class="form-control text-white fs-4 bg-transparent border-light p-3 shanniFont fs-2" placeholder="wFrfBcMj">
