...
<!--Main Section Start-->
    <div class="bg-secondary row d-flex justify-content-center">
            <div class="col-lg-6 text-center text-lg-start ">
                ...
                <p class="text-black fw-bold shanniFont fs-4">{{ $post->title }}</p>
                ...
                <div class="form-control bg-secondary">
                    ...
                    <select name="postCategory" id="selectCategory" class="rounded-3 shanniFont fs-4">
            ...
            <div class="my-3 mx-auto d-flex justify-content-center">
                ...
                <p class="pLcountText mx-1 shanniFont" style="display:inline-block">{{ $post->like_count}}</p>
                ...
                <p class="pULcountText text-black shanniFont" style="display:inline-block">{{ $post->ulike_count}}</p>
                ...
                <span class="viewCountText d-flex text-black ms-3 shanniFont">{{ $post->view_count }}</span>
                <i class="fa-solid fa-eye-slash text-black fw-bold mt-1"></i>
            </div>  <!-- comment  box -->

            <form class="commentBox hideDiv m-auto">
                <div class="d">
                    <input type="text" id="commentInput" onchange="sendcomment()" class="form-control d-inline-block bg-secondary justify-content-center shanniFont fs-5" style="width:400px;">
                    ...
                    <div class="form-control bg-secondary my-1">
                        ...
                        <p class=" my-2 mx-1 text-black fs-6 shanniFont"> {{ $cmt->comment_message }} </p>
        ...
        <div class="p-2">
            <h5 class="text-black text-center shanniFont fs-4">{{ $post->title }}</h5>
            <p class="text-black fw-bold shanniFont m-2 bg-secondary">{{ $post->description }}</p>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
            ...
            $.ajax({
                type: 'get',
                url : 'http://127.0.0.1:8000/ajax/user/add_viewCount',
                data: $data,
                dataType:'json',
                success:'response'
            })
