    ...
    <div class="container my-5 py-5 px-lg-5 w3-container w3-center w3-animate-zoom">
        ...
        <form class="row g-5 py-5" action="{{ route('admin#postEdit') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-6 text-center text-lg-start overflow-x-hidden overflow-y-auto">
                ...
                <input type="text" name="postTitle" title="post-title" value="{{ $post->title }}" class=" my-1 rounded-3 border border-light text-black fw-bold p-2 shanniFont fs-4">
                @error('postTitle')
                ...
                <span class="d-flex">
                    <p class="text-black fw-bold mx-2 my-3 viewCountText shanniFont">{{ $post->view_count }}</p> <i class="fa-solid fa-eye-slash text-black fw-bold mx-2 my-3"></i>
                ...
                <textarea name="postDescription" id="description" cols="30" rows="10" class="form-control m-2 p-2 text-black fw-bold shanniFont fs-4">
                    {{ $post->description }}
                </textarea>
