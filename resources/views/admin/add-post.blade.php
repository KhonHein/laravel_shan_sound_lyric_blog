...
<div class="container-xxl addPostContainer py-5 mb-5 row">
    ...
    <div class="category-side col-md-6 col-sm-12 col-lg-6">
        ...
        <form action="{{ route('admin#addCategory') }}" method="POST">
            ...
            <input type="text" name="categoryName" id="categoryName" class="form-control mx-2 my-3 p-2 shanniFont fs-4" required  placeholder="wFrfBogFxFOfjzkifj">
    ...
    <div class="psot-side col-md-6 col-sm-12 col-lg-6">
        ...
        @enderror
        <input type="text" name="postTitle" id="postName" class="form-control mx-2 my-3 p-2 shanniFont fs-4" placeholder="wFrfBogF [lOfjacMV">
        ...
        <textarea name="postDescription" id="description" cols="30" rows="10" class="form-control m-2 p-2 text-black fw-bold shanniFont fs-4"></textarea>
